...
| COR_PROFILER_ASSEMBLY_PATHS       | `1` or `0`, default `0`                  | Print the path to loaded assemblies in the trace file (required to use `@AssemblyDir`, hence enabled by default). |
