...
namespace Profiler {
	...
	STDAPI DllUnregisterServer() {
		...
		WideCharToMultiByte(CP_ACP, 0, szWID, -1, szID, sizeof(szID), nullptr, nullptr);
	...
	HRESULT RegisterClassBase(REFCLSID rclsid, const char* szDesc,
		...
		// Create ProgID keys.
		success &= CreateFullKeyAndRegister(szProgID, nullptr, szDesc);
		success &= CreateFullKeyAndRegister(szProgID, "CLSID", szID);

		// Create VersionIndependentProgID keys.
		success &= CreateFullKeyAndRegister(szIndepProgID, nullptr, szDesc);
		...
		success &= CreateFullKeyAndRegister(szOutCLSID, nullptr, szDesc);
		...
		success &= CreateFullKeyAndRegister(szOutCLSID, "VersionIndependentProgID",
			szIndepProgID);
		success &= CreateFullKeyAndRegister(szOutCLSID, "NotInsertable", nullptr);
	...
	BOOL CreateFullKeyAndRegister(const char* szKey, const char* szSubkey,
		...
		return CreateRegistryKeyAndSetValue(rcKey, nullptr, szValue);
	}
	...
	BOOL CreateRegistryKeyAndSetValue(const char* szKeyName, const char* szKeyword, const char* szValue) {
		...
		if (RegCreateKeyExA(HKEY_CLASSES_ROOT, szKeyName, 0, nullptr,
